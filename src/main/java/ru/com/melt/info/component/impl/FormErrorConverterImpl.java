...
import ru.com.melt.info.annotation.EnableFormErrorConversion;
...
public class FormErrorConverterImpl implements FormErrorConverter {
    ...
    public void convertToFieldError(Class<? extends Annotation> validationAnnotationClass, Object formInstance, BindingResult bindingResult) {
        ...
        if (!found) {
            throw new IllegalArgumentException("validationAnnotationClass not found for EnableFormErrorConversion annoattion: validationAnnotationClass=" + validationAnnotationClass
